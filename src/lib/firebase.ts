...
const firebaseConfig = {
  ...
  // CORRECCIÓN: Forzamos el uso del bucket correcto donde SÍ configuramos los permisos.
  // El error anterior ocurría porque la app apuntaba a "...appspot.com" por defecto.
